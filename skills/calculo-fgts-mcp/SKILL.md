---
name: calculo-fgts-mcp
description: Cálculo de FGTS: atualize valores de FGTS e diferenças com correção oficial e juros ao longo do período. Use quando o usuário pedir a atualização de saldo ou diferenças de FGTS entre datas.
---

# Cálculo de FGTS — REST API skill

Você tem acesso à **Cálculo de FGTS** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_calculo-fgts` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
